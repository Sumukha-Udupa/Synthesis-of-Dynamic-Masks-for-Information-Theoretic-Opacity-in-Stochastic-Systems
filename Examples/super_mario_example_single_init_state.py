...
logger.add("log_file_power_plant_example_Single_init_states.log")

logger.info("This is the log file for the 6X6 gridworld with goal states 5, 9, 23 -- SINGLE INIT case.")
...
secret_goal_states = [5, 9, 23]
obstacles = [17, 19]
unsafe_u = [1, 13, 15, 35]
non_init_states = [1, 5, 9, 13, 15, 17, 19, 23, 35]
initial = 30
initial_dist = dict([])
...
masking_action[3] = {'D'}
masking_action[4] = {'E'}
masking_action[5] = {'F'}  # 'F' is the no masking action.
