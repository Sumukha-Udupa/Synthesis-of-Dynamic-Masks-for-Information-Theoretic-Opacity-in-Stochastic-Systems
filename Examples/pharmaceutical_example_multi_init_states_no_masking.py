...
def run_pharma_example_no_maskin(iter_num=1000, batch_size=100, V=100, T=10, eta=8.2, kappa=0.25, threshold=70,
                                 prior_compute_flag=0,
                                 exp_number=4, sensor_noise=0.15):
    logger.add(
        "logs_for_examples/log_file_mario_example_two_init_state_modified_observations_masking_action_visible_case1_part2_without_sensorE_threshold_35_no_masking.log")
