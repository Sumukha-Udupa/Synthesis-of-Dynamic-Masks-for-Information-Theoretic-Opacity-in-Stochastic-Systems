...
logger.add("logs_for_examples/log_file_mario_example_two_init_state_modified_observations_masking_action_visible_case1_part2_without_sensorE_threshold_35_modified_sensors_2.log")
...
setD = {6, 7, 8, 12, 13, 14}
# setE = {20}
setNO = {5, 11, 15, 16, 17, 18, 19, 24, 25, 26, 30, 31, 32, 33, 20, 27, 34, 1, 2, 0}
